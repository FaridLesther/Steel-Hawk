...
class Helicoptero(Enemigo.Enemigo):
    ...
    def mostrar_vida(self,superficie):#yop
        ...
        fuente=super().mostrar_vida(superficie)#yop se hereda la fuente de la Clase Enemigo
        texto = fuente.render(str(int(self.vida*(1/4)))+ "%", 0, (255, 0, 0))#yop texto de la vida del enemigo en formato de porcentaje
        superficie.blit(texto, (x +10 , y-50))#coloca el texto en la superficie(en este caso la ventana)